...
layout: post
title:  "Hosting Jekyll Blog on GitHub for Free"
date:   2023-08-04  
...
I have shown you on Windows. For other operating systems steps may be bit different.
We now need to go to [rubyinstaller][ruby-installer] and install ruby with devkit which suits your computer best (it's going to be in bold). Double click on rubyinstaller where it is downloaded. Keep clicking on the next button and then at the end finish. Now a new window will be opened where it will be written ruby installer for windows. Press on 1, 2 and 3 step by step.
...
Now you can search your repository on windows and find out that your website running.
